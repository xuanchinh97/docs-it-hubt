...
<table border="0" width="97%" id="table1">
	...
	<tr>
		...
		<td width="63%" height="372" valign="top">
			<table border="1" width="100%" id="table5">
				<form method="POST" action="xllienhe.asp">
					
				<tr>
					<td width="134" align="right">H&#7885; tên:</td>
					<td><input type="text" name="hoten" size="20"></td>
				</tr>
				<tr>
					<td width="134" align="right">&#272;&#7883;a ch&#7881;:</td>
					<td><input type="text" name="diachi" size="20"></td>
				</tr>
				<tr>
					<td width="134" align="right">&#272;i&#7879;n tho&#7841;i:</td>
				...
				<tr>
					<td width="134" align="right">Tiêu &#273;&#7873;:</td>
					<td><input type="text" name="tieude" size="20"></td>
				</tr>
				<tr>
					<td width="134" align="right">N&#7897;i dung:</td>
					<td><textarea rows="7" name="noidung" cols="29"></textarea></td>
				</tr>
				<tr>
					<td width="134">&nbsp;</td>
					<td><input type="submit" value="Ch&#7845;p nh&#7853;n" name="B1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="reset" value="Làm l&#7841;i" name="B2"></td>
				</tr>
				</form>
			</table>
			<p>&nbsp;</td>
	...
	<tr>
		...
		<font color="#FFFFFF">Công ty TNHH qu&#7843;ng bá s&#7843;n ph&#7849;m&nbsp; &#272;&#7883;a ch&#7881; : S&#7889; 1 Hàng Than, Hà N&#7897;i 
		&#272;i&#7879;n tho&#7841;i : 099000222200022</font><p>
		<font color="#FFFFFF">Design by : vnn</font></td>
	</tr>
</table>
