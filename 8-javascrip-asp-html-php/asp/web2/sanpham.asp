...
<table border="0" width="97%" id="table1">
	...
	<tr>
		...
		%>
			...
			<tr>
				<td colspan="2" valign="top" height="5"><% = Banghi_sanpham.Fields("tensp") %></td>
			</tr>
			<tr>
				<td width="101" valign="top">
				<img border="0" src="<% = Banghi_sanpham.Fields("anhsp") %>" width="243" height="260"></td>
				<td valign="top"><% = Banghi_sanpham.Fields("thongtinsp") %></td>
			</tr>
