...
<table border="0" width="97%" id="table1">
	<tr>
		...
		<table border="0" width="100%" id="table2">
			<tr>
				<td width="168">
				<img border="0" src="<% =Banghi_logobanner.Fields("logo")    %>" width="165" height="166"></td>
				<td>
				<img border="0" src="<% =Banghi_logobanner.Fields("banner")    %>" width="1096" height="164"></td>
			</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		...
		<table border="1" width="100%" id="table5">
			<tr>
				...
				<td align="center" width="98">Tel </td>
				<td align="center" width="143">Email</td>
				<td align="center" width="223">Ngày tháng</td>
			</tr>
			
	<% Do While Not Banghi_lienhe.EOF	%>	
			<tr>
				<td><%=Banghi_lienhe.Fields("hovaten")%></td>
				<td><%=Banghi_lienhe.Fields("diachi")%></td>
				<td width="98"><%=Banghi_lienhe.Fields("dienthoai")%></td>
				<td width="143"><%=Banghi_lienhe.Fields("email")%></td>
				<td width="223"><%=Banghi_lienhe.Fields("ngaythang")%></td>
			</tr>
			
	<%
	Banghi_lienhe.MoveNext
	Loop
	%>		
		</table>
		</td>
